...
import com.mx.dlna.util.FileUtil;
import com.mx.dlna.util.UpnpUtil;
import com.mx.dlna.util.Utils;
...
public class MediaServer {
    ...
    public MediaServer(Context context) throws ValidationException {
        ...
        DeviceDetails details = new DeviceDetails("Android" + " ("

...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        Log.d(TAG, "host:" + NetUtils.getHostName() + " ip:" + NetUtils.getHostAddress());
        if (null != NetUtils.getHostName()
                && null != NetUtils.getHostAddress()) {
            systemSalt.append(NetUtils.getHostName()).append(
